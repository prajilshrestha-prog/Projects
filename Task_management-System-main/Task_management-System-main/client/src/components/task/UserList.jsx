...
export const UserList = ({ setTeam, team }) => {
  ...
  useEffect(() => {
    if (!isLoading && data && data.length > 0 && selectedUsers.length === 0) {
    ...
    <div>
      ...
      <Listbox value={selectedUsers} onChange={handleChange} multiple>
        <div className='relative mt-1'>
          <Listbox.Button className="relative w-full cursor-default rounded bg-white pl-3 pr-10 text-left py-2.5 border border-gray-300 dark:border-gray-600 sm:text-sm">
